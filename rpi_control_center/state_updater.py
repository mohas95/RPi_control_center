...
class Relay():
    ...
    def __init__(self, id, name, pin, state=False, refresh_rate = 1, api_dir ='./api/', log_dir = './logs/'):
        ...
        self.logger = setup_logger(name=str(__name__)+"_process_logger", logfile=log_file, level=20, formatter = formatter, maxBytes=2e6, backupCount=3)
...
class BulkUpdater():
    ...
    def __init__(self,config_file, default_config = default_relay_config , refresh_rate = 1, log_dir = './logs/'):
        ...
        self.logger = setup_logger(name=str(__name__)+"_status_logger", logfile=log_file, level=20, formatter = formatter, maxBytes=2e6, backupCount=3)
